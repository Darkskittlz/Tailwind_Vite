...
import Embla13 from "../assets/Cruise&Business/AnchorStandards.mp4"

export const slides = [
  {
    Embla1SubHeader: "CRUISE & TRAVEL BUSINESS UPDATES - RFP RESPONSES",
    Embla1Br: <br />,
    heading: "RFP RESPONSES TO STARBOARD DIFFERENTIATORS",
    Embla1text: "Our selected categories: ",
    Embla1text2: "a) Product",
    Embla1text3: "c) Service",
    Embla1text4: "d) Technology",
    Embla1text5: "e) Innovation",
    Embla1text6: "g) Logistics",
    Embla1text7: "h) Infrastructure",
    Embla1text8: "i) Recruitment, Training & Development",
    Embla1text9: "k) Any relevant Business won since 2019",
    Embla1text10: "l) Any relevant restructure/ change within the cruise/travel business of your company"
  },
  {
    Embla2image: Embla2,
  ...
  },
  {
    ...
    Embla8Br: <br />,
    Embla8text: `We use digital experiences to engage guests and make their shopping experience more engaging while increasing conversion.`
  },
  {
    Embla9image: Embla9,
    Embla9caption1: "Miami Distribution Center",
    Embla9heading: "OPERATIONAL EXCELLENCE",
                      ...
                      <div className='w-full flex'>
                        ...
                        <InnerContainer2>
                          <video
                            ...
                            muted
                            key={`image-${index}-1`}
                            className="embla__slide__img ml-32"
                    ...
                    <ModalContainer3>
                      ...
                      <div className='w-full flex justify-center flex-col'>
                        ...
                        <div className='flex items-center flex-col'>
                          <Caption6Container>
                            <h2>
                              <ul className="-ml-24 list-disc list-inside">
                                <li>
                  ...
                  slide.Embla10image && (
                    <ModalContainer3>
                      ...
                      <div className='w-full flex ml-10 justify-center flex-col'>
                        <div>
                          <h3 className="xs:text-1xl pr-10 text-black">
                            {slide.Embla10text}
                            {slide.Embla10Br}
                            {slide.Embla10Br}
                            {slide.Embla10text2}
                ...
                {/* Slide 11 */}
                {
                  slide.Embla11text && (
                    <div className='w-full flex justify-between'>
                      <div className='w-3/4 ml-2.5 -mt-24 p-5'>
                        <h3 className="xs:text-1xl pr-10 text-black">
                          {slide.Embla11Br}
                          {slide.Embla11Br}
                          {slide.Embla11text}
                ...
                {/* Slide 13 */}
                {
                  slide.Embla13text && (
                    <ModalContainer3>
                      ...
                      <InnerIMG3Container>
                        <img src={slide.Embla13image['1']} className="" key={`image-${index}-31`} />
                        <img src={slide.Embla13image['2']} className="" key={`image-${index}-32`} />
                        <img src={slide.Embla13image['3']} className="" key={`image-${index}-33`} />
                        <img src={slide.Embla13image['4']} className="" key={`image-${index}-34`} />
                        <img src={slide.Embla13image['5']} className="mt-2" key={`image-${index}-35`} />
                        <img src={slide.Embla13image['6']} className="mt-3" key={`image-${index}-36`} />
                        <img src={slide.Embla13image['7']} className="mt-2" key={`image-${index}-37`} />
                        <img src={slide.Embla13image['8']} className="-mt-1" key={`image-${index}-38`} />
                        <img src={slide.Embla13image['9']} className="mt-2" key={`image-${index}-39`} />
                        <img src={slide.Embla13image['10']} className="" key={`image-${index}-40`} />
                        <img src={slide.Embla13image['11']} className="" key={`image-${index}-41`} />
                        <img src={slide.Embla13image['12']} className="" key={`image-${index}-42`} />
                        <img src={slide.Embla13image['13']} key={`image-${index}-43`} />
                        <img src={slide.Embla13image['14']} key={`image-${index}-44`} />
                        <img src={slide.Embla13image['15']} className="mt-2" key={`image-${index}-45`} />
                        <img src={slide.Embla13image['16']} className="mt-2" key={`image-${index}-46`} />
                  ...
                  slide.Embla14text && (
                    <ModalContainer3>
                      ...
                      <div className='w-full ml-10 flex justify-center flex-col'>
                        <div>
                          <h3 className="xs:text-1xl mb-5 pr-10 text-black">
                            {slide.Embla14text}
                            {slide.Embla14Br}
                            {slide.Embla14Br}
                            {slide.Embla14text2}
