          ...
          <BlueBulletContainer>
            <div className="reveal lg:flex-row-reverse xs:flex-col w-full flex  align-top">
              ...
              <div className="w-5/6 xl:pl-12 lg:pl-0 md:ml-0 xs:ml-2 md:pl-0 md:pr-32 xs:mb-20 xs:w-full reveal">
                ...
                <h2 className="mb-10 xl:text-5xl lg:text-4xl md:font-semibold xs:text-4xl xs:mt-12 md:mt-0 text-black">INVESTING IN FINE JEWELRY, SWISS, AND LUXE TALENT</h2>
                <h3 className="text-2xl xl:text-4xl lg:text-3xl xs:text-4xl text-black">
                  The appointment of Caryl Capeci as the Senior Vice President of Fine Jewelry and Watches affirms our commitment to top talent driving revenue growth. Transitioning from her advisory role, Caryl brings a wealth of experience and leadership, having previously served as the CEO of Hearts on Fire<span className='sup'>®</span>, The World's Most Perfectly Cut Diamond<span className='sup'>®</span>.
                </h3>
              </div>
            </div>
          </BlueBulletContainer>
