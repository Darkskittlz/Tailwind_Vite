      ...
      <Margin2Container>
        <div className="lg:flex-row xs:flex-col md:flex-col ml-10 mr-10 items-center flex">
          ...
          <div className="w-5/6 xl:pl-32 lg:pl-0 lg:ml-32 md:ml-0 xs:ml-0 md:pl-0 md:mt-10 xs:w-full xs:mt-5 pr-32 reveal">
            <h2 className="mb-10 xl:text-5xl lg:text-4xl xs:text-4xl font-semibold  text-black">When the sun goes down, your clients' night onboard Icon of the Seas lights up with possibilities. </h2>
