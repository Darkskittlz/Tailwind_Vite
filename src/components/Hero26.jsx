    ...
    <section>
      <div className="lg:flex-row xs:flex-col md:flex-col m-10 items-center flex">
        <div className="reveal w-full flex align-top">
          <h5 className="text-3xl text-left mt-5 ml-5 absolute font-semibold"><ul className="list-disc list-inside"><li className="listItem">ICONIC ENTERTAINMENT</li></ul></h5>
          <img
