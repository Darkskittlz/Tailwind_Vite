    ...
    <section>
      <div className="lg:flex-row xs:flex-col md:flex-col m-10 items-center flex">
        <div className="reveal w-full flex align-top">
          <h5 className="text-3xl text-left mt-5 ml-5 absolute font-semibold"><ul className="list-disc list-inside"><li className="listItem">ICON OF THE SEAS</li></ul></h5>
          <img
        ...
        <div className="w-5/6 xl:pl-32 lg:pl-0 lg:ml-32 md:ml-0 xs:ml-0 md:pl-0 md:mt-10 xs:w-full xs:mt-5 pr-32 reveal">
          <h2 className="mb-10 xl:text-5xl lg:text-4xl xs:text-4xl leading-4 text-black">Departing the Shipyard </h2>
