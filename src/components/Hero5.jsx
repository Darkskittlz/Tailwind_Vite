    ...
    <section>
      <Margin2Container>
        <div className="lg:flex-row xs:flex-col xs:m-10 justify-between flex">
          ...
          <div className="w-5/6 xl:pl-12 lg:pl-0 lg:ml-32 md:ml-0 xs:ml-2 md:pl-0 md:pr-32 xs:mb-20 xs:w-full reveal">
            <h2 className="mb-10 xl:text-5xl lg:text-4xl md:font-semibold xs:text-4xl xs:mt-12 md:mt-0 text-black">Take the best-ever vacation and crank it up — way up. This is a whole new class of adventure. The kind that fills every moment with new thrills and changes the way your clients play for good.</h2>
