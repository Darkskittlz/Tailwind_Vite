      ...
      <Margin2Container>
        <div className="lg:flex-row md:flex-col xs:mx-10 xs:flex-col justify-between flex">
          ...
          <div className="w-5/6 xl:pl-12 xl:mt-24 xl:pr-72 lg:pl-0 md:w-full md:m-10 md:pr-6 md:pl-0 md:pb-32 reveal">
            <h2 className="mb-10 xl:text-5xl lg:text-4xl md:text-4xl md:font-bold md:mt-20 xs:text-4xl text-black">From upbeat party scenes to family-friendly hangs and restful retreats — the new <span className="italic">Icon of the Seas</span> has a pool for every mood.</h2>
